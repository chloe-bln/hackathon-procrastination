                  ...
                  children: [
                    ...
                    LayoutBuilder(
                      builder: (context, constraints) {
                        ...
                        final avatar = _AvatarPanel(hair: s.avatarHair, clothes: s.avatarClothes, skin: s.avatarSkin);
                        return narrow
                    ...
                    PastelCard(
                      child: Row(
                        children: [
                          ...
                          Expanded(child: Text('${app.blockedApps.length} blocked items configured. Each completed goal unlocks one for 30 minutes.')),
                          OutlinedButton(
    ...
    return PastelCard(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 16),
          Text('Focus tracked today: ${_formatGoalFocus(app.focusSecondsToday)} · end-of-day bonus: ${app.focusSecondsToday ~/ 120} XP', style: Theme.of(context).textTheme.bodySmall),
          const SizedBox(height: 16),
...
class _AvatarPanel extends StatelessWidget {
  const _AvatarPanel({required this.hair, required this.clothes, required this.skin});
  ...
  Widget build(BuildContext context) {
    return PastelCard(
      child: Column(
        children: [
          AvatarPreview(hair: hair, clothes: clothes, skin: skin),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text('${goal.durationMinutes} min focus session · tracked ${_formatGoalFocus(goal.focusSeconds)}', style: Theme.of(context).textTheme.bodySmall),
...
String _formatGoalFocus(int seconds) {
